...
package com.harvey.rxjava.module.data;

import android.support.annotation.IntDef;
import android.support.annotation.NonNull;

import com.harvey.rxjava.App;
...
public class Data {
    ...
    public Disposable subscribeData(@NonNull DisposableObserver<List<Item>> observer) {
        if (cache == null) {
            cache = BehaviorSubject.create();
            Observable.create(new ObservableOnSubscribe<List<Item>>() {
                @Override
                public void subscribe(@io.reactivex.annotations.NonNull ObservableEmitter<List<Item>> e) throws Exception {
        ...
        return cache.observeOn(AndroidSchedulers.mainThread()).subscribeWith(observer);
    }
